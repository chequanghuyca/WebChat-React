...
const Search = () => {
  ...
  const handleSelect = async () => {
    const combinedId = currentUser.uid > user.ui ? currentUser.uid + user.uid : user.uid + currentUser.uid;
  ...
  return (
    <div className='search'>
      <div className='searchForm'>
        <input type='text' placeholder='Tìm một người dùng' onKeyDown={handleKey} onChange={(e) => setUsername(e.target.value)} value={username} />
      </div>
